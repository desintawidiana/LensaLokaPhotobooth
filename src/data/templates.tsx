...
export const TEMPLATES: Template[] = [
  ...
  // ============================================================
  {
    ...
    renderBackground: () => (
      <div className="absolute inset-0 overflow-hidden opacity-30">
        ...
        <div className="absolute top-1/2 left-1/4 text-white/60 animate-pulse">
          <Zap size={28} />
        </div>
        <div className="absolute bottom-1/3 right-1/4 text-white/60 animate-pulse">
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4">
        ...
        <div className="absolute top-[10%] left-2 text-4xl animate-bounce">
          ✨
        </div>
        <div className="absolute top-[10%] right-2 text-4xl animate-bounce">
          ⭐
        </div>
        <div className="absolute bottom-[20%] left-2 text-3xl">💖</div>
        <div className="absolute bottom-[20%] right-2 text-3xl">🌟</div>
        <div className="absolute top-[40%] left-1 text-2xl rotate-12">💫</div>
        <div className="absolute top-[40%] right-1 text-2xl -rotate-12">✦</div>
        <div className="absolute bottom-[35%] left-3 text-xl">🎀</div>
        <div className="absolute bottom-[35%] right-3 text-xl">💝</div>
      </div>
    ),
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none border-8 border-white/30 rounded-xl m-2 flex flex-col justify-between">
        ...
        <div className="absolute top-[30%] left-2 text-3xl">🍒</div>
        <div className="absolute top-[30%] right-2 text-3xl">💕</div>
        <div className="absolute bottom-[35%] left-1 text-2xl">🌺</div>
        <div className="absolute bottom-[35%] right-1 text-2xl">🧁</div>
  ...
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4">
        ...
        <div className="absolute top-[12%] left-3 text-4xl text-[#D4AF37] animate-pulse">
          🎞️
        </div>
        <div className="absolute top-[12%] right-3 text-4xl text-[#D4AF37] animate-pulse">
          🎬
        </div>
        ...
        <div className="absolute top-[35%] left-2 text-3xl text-[#D4AF37]/80">
          🎥
        </div>
        <div className="absolute top-[35%] right-2 text-3xl text-[#D4AF37]/80">
          📷
        </div>
        <div className="absolute bottom-[40%] left-3 text-xl text-[#D4AF37]/70">
          🌟
        </div>
        <div className="absolute bottom-[40%] right-3 text-xl text-[#D4AF37]/70">
          ⭐
        </div>
  ...
  },
  {
    ...
    renderBackground: () => (
      <div className="absolute inset-0 border-[6px] border-white/60 border-dashed m-2 rounded-2xl opacity-70">
        <div className="absolute top-20 left-4 text-white animate-pulse">
          <Heart size={16} fill="currentColor" />
        </div>
        <div className="absolute bottom-32 right-4 text-white animate-pulse">
          <Heart size={20} fill="currentColor" />
        </div>
        <div className="absolute top-1/3 right-6 text-white/80">
          <Sparkles size={18} />
        </div>
        <div className="absolute bottom-1/2 left-6 text-white/80">
          <Ribbon size={22} />
        </div>
      </div>
    ),
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between">
        ...
        <div className="absolute top-[15%] -left-2 text-4xl rotate-[-15deg] animate-bounce">
          🎀
        </div>
        <div className="absolute top-[15%] -right-2 text-4xl rotate-[15deg] animate-bounce">
          🎀
        </div>
        <div className="absolute bottom-[20%] left-3 text-2xl">💕</div>
        <div className="absolute bottom-[20%] right-3 text-2xl">💗</div>
        <div className="absolute top-[35%] left-1 text-3xl">🌸</div>
        <div className="absolute top-[35%] right-1 text-3xl">💝</div>
        <div className="absolute bottom-[40%] left-2 text-xl">🦋</div>
        <div className="absolute bottom-[40%] right-2 text-xl">✨</div>
  ...
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-6">
        ...
        <div className="absolute top-[40%] left-2 text-3xl">🎥</div>
        <div className="absolute top-[40%] right-2 text-3xl">🎞️</div>
        <div className="absolute bottom-[35%] left-3 text-xl">🌟</div>
        <div className="absolute bottom-[35%] right-3 text-xl">⭐</div>
  ...
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none border-4 border-black/30 m-3 rounded-lg flex flex-col justify-between p-4">
        ...
        <div className="absolute bottom-[20%] left-3 text-2xl">🌵</div>
        <div className="absolute bottom-[20%] right-3 text-2xl">👢</div>
        <div className="absolute top-[35%] left-1 text-3xl">🏜️</div>
        <div className="absolute top-[35%] right-1 text-3xl">⭐</div>
        <div className="absolute bottom-[40%] left-2 text-xl">🐂</div>
        <div className="absolute bottom-[40%] right-2 text-xl">🎸</div>
  ...
  },
  {
    ...
    renderBackground: () => (
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/3 left-4 text-white/60">
          <Waves size={40} />
        </div>
      </div>
    ),
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4">
        ...
        <div className="absolute top-[35%] left-1 text-3xl">🌊</div>
        <div className="absolute top-[35%] right-1 text-3xl">🐚</div>
        <div className="absolute bottom-[40%] left-2 text-xl">☀️</div>
        <div className="absolute bottom-[40%] right-2 text-xl">🌴</div>
  ...
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4">
        ...
        <div className="absolute top-[12%] left-2 text-4xl animate-bounce">
          🍭
        </div>
        <div className="absolute top-[12%] right-2 text-4xl animate-bounce">
          🍒
        </div>
        <div className="absolute bottom-[20%] left-3 text-2xl">✨</div>
        <div className="absolute bottom-[20%] right-3 text-2xl">🍬</div>
  ...
  },
  {
    ...
    renderBackground: () => (
      ...
      >
        <div className="absolute top-1/3 right-1 text-white/80 animate-pulse">
          <Cat size={40} fill="currentColor" />
        </div>
        <div className="absolute bottom-1/4 left-2 text-white/60">
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none p-3 flex flex-col justify-between border-4 border-white/60 m-2 rounded-2xl shadow-inner">
        ...
        <div className="absolute top-[35%] left-1 text-3xl">😺</div>
        <div className="absolute top-[35%] right-1 text-3xl">🎀</div>
        <div className="absolute bottom-[35%] left-2 text-xl">💕</div>
        <div className="absolute bottom-[35%] right-2 text-xl">🌸</div>
      </div>
    ),
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4 border-4 border-white/40 m-1">
        <div className="flex justify-between text-white drop-shadow-md">
          <Sparkle size={28} fill="currentColor" className="animate-pulse" />
  ...
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4">
        ...
        <div className="absolute bottom-[20%] -left-2 text-3xl">⭐</div>
        <div className="absolute top-[15%] left-1 text-2xl">✨</div>
        <div className="absolute top-[15%] right-1 text-2xl">💫</div>
        <div className="absolute bottom-[40%] left-2 text-xl">🌟</div>
        <div className="absolute bottom-[40%] right-2 text-xl">💖</div>
        <div
  ...
  },
  {
    ...
    renderBackground: () => (
      <div className="absolute inset-0 bg-gradient-to-b from-black/40 to-transparent">
        <div className="absolute top-4 left-2 text-white/30 rotate-12 animate-pulse">
          <Ghost size={36} fill="currentColor" />
        </div>
        <div className="absolute bottom-10 right-2 text-white/30 -rotate-12 animate-pulse">
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4">
        ...
        <div className="absolute bottom-[20%] -left-2 text-3xl">🦇</div>
        <div className="absolute top-[30%] left-2 text-2xl">🕷️</div>
        <div className="absolute top-[30%] right-2 text-2xl">🕸️</div>
        <div className="absolute bottom-[40%] left-1 text-xl">🌙</div>
        <div className="absolute bottom-[40%] right-1 text-xl">⭐</div>
      </div>
    ),
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4">
        ...
        <div className="absolute top-[35%] left-1 text-2xl">🌱</div>
        <div className="absolute top-[35%] right-1 text-2xl">🍀</div>
        <div className="absolute bottom-[40%] left-2 text-xl">🌾</div>
        <div className="absolute bottom-[40%] right-2 text-xl">💎</div>
      </div>
    ),
  },
  {
    ...
    renderBackground: () => (
      <div className="absolute inset-0 bg-gradient-to-b from-black/60 to-transparent opacity-80">
        <div className="absolute top-10 left-4 text-white/40 animate-pulse">
          <Ghost size={40} />
        </div>
        <div className="absolute bottom-20 right-4 text-white/40 animate-pulse">
          <Moon size={40} />
        </div>
        <div className="absolute top-1/3 right-6 text-white/30">
  ...
  },
  {
    ...
    renderBackground: () => (
      ...
      >
        <div className="absolute top-1/4 left-2 text-white/60 animate-pulse">
          <Heart size={30} fill="currentColor" />
        </div>
        <div className="absolute bottom-1/3 right-2 text-white/60 animate-pulse">
          <Sparkles size={30} />
        </div>
        <div className="absolute top-1/2 right-4 text-white/50">
          <Star size={24} fill="currentColor" />
        </div>
      </div>
    ),
  ...
  },
  {
    ...
    renderBackground: () => (
      ...
      >
        <div className="absolute top-6 right-3 text-white/70 animate-pulse">
          <Waves size={36} />
        </div>
        <div className="absolute bottom-1/4 left-4 text-white/60">
          <Droplets size={28} />
        </div>
      </div>
    ),
  ...
  },
  {
    ...
    renderBackground: () => (
      <div className="absolute inset-0 overflow-hidden bg-gradient-to-b from-black/40 to-transparent">
        ...
        <div className="absolute top-6 left-3 text-white/30 animate-pulse">
          <Sparkles size={32} />
        </div>
        <div className="absolute bottom-1/3 right-4 text-white/40">
  ...
  },
  {
    ...
    renderBackground: () => (
      <div className="absolute inset-0 bg-gradient-to-b from-sky-200/40 to-transparent">
        <div className="absolute top-8 left-3 text-white/70 animate-pulse">
          <Cloud size={36} fill="currentColor" />
        </div>
        <div className="absolute bottom-12 right-3 text-white/70 animate-pulse">
          <Cloud size={28} fill="currentColor" />
        </div>
        <div className="absolute top-1/3 right-6 text-white/60">
          <Sparkles size={24} />
        </div>
      </div>
    ),
  ...
  },
  {
    ...
    defaultBg: '#1E1B4B',
    renderBackground: () => (
      <div className="absolute inset-0 overflow-hidden bg-gradient-to-b from-purple-900/40 to-transparent">
        <div
          className="absolute inset-0 opacity-20"
          style={{
            backgroundImage:
        ...
        />
        <div className="absolute top-6 right-4 text-purple-400/60 animate-pulse">
          <Zap size={40} />
        </div>
        <div className="absolute bottom-8 left-4 text-pink-400/60 animate-pulse">
          <Sparkles size={36} />
        </div>
      </div>
    ),
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4 border-4 border-purple-500/40 m-2 rounded-xl">
        <div className="font-mono text-purple-300 text-xl text-center tracking-widest bg-black/60 py-1 px-3 rounded-md border border-purple-500/50 mt-1">
          ⚡ NEON CITY ⚡
        </div>
        <div className="absolute top-[12%] left-2 text-4xl">🌃</div>
        <div className="absolute top-[12%] right-2 text-4xl">💜</div>
  ...
  },
  {
    ...
    renderBackground: () => (
      <div className="absolute inset-0 bg-gradient-to-b from-orange-200/30 to-transparent">
        <div className="absolute top-4 right-3 text-white/70 animate-pulse">
          <Sun size={50} fill="currentColor" />
        </div>
        <div className="absolute bottom-6 left-3 text-white/60">
          <Palmtree size={40} />
        </div>
        <div className="absolute top-1/3 left-1/4 text-white/50">
          <Flower2 size={28} />
        </div>
      </div>
    ),
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4">
        <div className="font-pacifico text-orange-600 text-2xl text-center drop-shadow-sm mt-2">
          Paradise Found
        </div>
        <div className="absolute top-[15%] left-2 text-4xl">🌺</div>
        <div className="absolute top-[15%] right-2 text-4xl">🥥</div>
  ...
  },
  {
    ...
    renderBackground: () => (
      <div
        ...
        style={{
          backgroundImage:
            'repeating-radial-gradient(circle, #000 0, #000 3px, transparent 3px, transparent 15px)',
        }}
      >
        <div className="absolute top-8 left-4 text-black/20 rotate-12">
          <Music size={40} />
        </div>
        <div className="absolute bottom-10 right-4 text-black/20 -rotate-12">
          <Headphones size={36} />
        </div>
      </div>
    ),
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4">
        <div className="font-cherry text-3xl text-purple-600 text-center tracking-wider drop-shadow-[0_2px_0_rgba(255,255,255,0.8)] mt-1">
          FESTIVAL
        </div>
        <div className="absolute top-[12%] left-2 text-4xl">🎸</div>
        <div className="absolute top-[12%] right-2 text-4xl">🎤</div>
  ...
  // ============================================================
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none p-4 flex flex-col justify-between border-4 border-dashed border-white/60 m-1.5 rounded-xl">
        ...
        <div className="absolute top-[30%] left-1 text-2xl">🌸</div>
        <div className="absolute top-[30%] right-1 text-2xl">🍒</div>
        <div className="absolute bottom-[35%] left-2 text-xl">💕</div>
        <div className="absolute bottom-[35%] right-2 text-xl">🧁</div>
      </div>
    ),
  ...
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4 border-[6px] border-white/60 m-1.5 rounded-xl shadow-sm">
        ...
        <div className="absolute top-[30%] left-1 text-2xl text-cyan-400">
          🎮
        </div>
        <div className="absolute top-[30%] right-1 text-2xl text-cyan-400">
          💿
        </div>
        <div className="absolute bottom-[35%] left-2 text-xl text-cyan-400">
          🖥️
        </div>
        <div className="absolute bottom-[35%] right-2 text-xl text-cyan-400">
          📱
        </div>
  ...
  },
  {
    ...
    renderBackground: () => (
      <div className="absolute inset-0 bg-gradient-to-t from-black/10 via-white/20 to-transparent">
        <div className="absolute top-12 left-4 text-white/60 animate-pulse">
          <Cloud size={28} fill="currentColor" />
        </div>
        <div className="absolute top-20 right-4 text-white/60 animate-pulse">
  ...
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-5 border-2 border-white/60 m-2 rounded-xl">
        ...
        <div className="absolute top-[30%] left-2 text-2xl text-gray-500">
          ◆
        </div>
        <div className="absolute top-[30%] right-2 text-2xl text-gray-500">
          ◆
        </div>
        <div className="absolute bottom-[35%] left-3 text-xl text-gray-600">
          ✧
        </div>
        <div className="absolute bottom-[35%] right-3 text-xl text-gray-600">
          ✧
        </div>
      </div>
    ),
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-6 border-[3px] border-white/30 m-3 rounded-[3rem]">
        ...
        <div className="absolute top-[30%] left-3 text-3xl text-white/40">
          ✧
        </div>
        <div className="absolute top-[30%] right-3 text-3xl text-white/40">
          ✧
        </div>
        <div className="absolute bottom-[35%] left-4 text-2xl text-white/50">
          ◆
        </div>
        <div className="absolute bottom-[35%] right-4 text-2xl text-white/50">
          ◆
        </div>
      </div>
    ),
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4 border-2 border-[#39FF14] m-2 rounded-xl shadow-[0_0_15px_#39FF14_inset]">
        ...
        <div className="absolute top-[30%] left-1 text-2xl">🤖</div>
        <div className="absolute top-[30%] right-1 text-2xl">💾</div>
        <div className="absolute bottom-[35%] left-2 text-xl">🕹️</div>
        <div className="absolute bottom-[35%] right-2 text-xl">🎮</div>
      </div>
    ),
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-6 border-[6px] border-white/80 m-3 rounded-full shadow-lg">
        ...
        <div className="absolute top-[35%] left-3 text-3xl">✨</div>
        <div className="absolute top-[35%] right-3 text-3xl">🌈</div>
        <div className="absolute bottom-[40%] left-4 text-2xl">💕</div>
        <div className="absolute bottom-[40%] right-4 text-2xl">🎀</div>
      </div>
    ),
  },
  {
  ...
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4 border-2 border-[#854D0E]/30 m-2 rounded-[2rem]">
        ...
        <div className="absolute bottom-[10%] left-2 text-3xl">🍯</div>
        <div className="absolute bottom-[10%] right-2 text-3xl">✨</div>
        <div className="absolute top-[30%] left-1 text-2xl">☀️</div>
        <div className="absolute top-[30%] right-1 text-2xl">🌼</div>
        <div className="absolute bottom-[35%] left-2 text-xl">💛</div>
        <div className="absolute bottom-[35%] right-2 text-xl">🦋</div>
      </div>
  ...
  },
  {
    ...
    defaultBg: '#2C1810',
    renderBackground: () => (
      <div className="absolute inset-0 border-x-[12px] border-black/90 flex flex-col justify-between py-1 bg-gradient-to-b from-black/40 to-transparent">
        {Array.from({
          length: 16,
        }).map((_, i) => (
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4">
        <div className="flex justify-between items-center text-[#D4AF37] px-2 mt-1">
          <Camera size={16} />
          <span className="font-mono text-[8px] tracking-widest font-bold bg-black/50 px-1 rounded">
            ISO 400
          </span>
          <Sparkle size={12} fill="currentColor" />
        </div>
        <div className="absolute top-[5%] left-2 text-4xl text-[#D4AF37]">
          🎞️
        </div>
        <div className="absolute top-[5%] right-2 text-4xl text-[#D4AF37]">
          🎬
        </div>
        <div className="absolute bottom-[10%] left-2 text-3xl text-[#D4AF37]/60">
          📸
        </div>
        <div className="absolute bottom-[10%] right-2 text-3xl text-[#D4AF37]/60">
          ✨
        </div>
        <div className="absolute top-[30%] left-1 text-2xl text-[#D4AF37]/80">
          🎥
        </div>
        <div className="absolute top-[30%] right-1 text-2xl text-[#D4AF37]/80">
          📷
        </div>
        <div className="absolute bottom-[35%] left-2 text-xl text-[#D4AF37]/70">
          🌟
        </div>
        <div className="absolute bottom-[35%] right-2 text-xl text-[#D4AF37]/70">
          ⭐
        </div>
        <div className="font-pacifico text-[#D4AF37] text-sm text-center tracking-wide bg-black/60 py-0.5 rounded mx-2 mb-1">
          Capturing Moments
        </div>
      </div>
    ),
  },
  {
    ...
    renderBackground: () => (
      <div className="absolute inset-0 overflow-hidden opacity-30">
        ...
        />
        <div className="absolute top-4 left-4 text-white rotate-12 animate-pulse">
          <Star size={32} fill="currentColor" />
        </div>
        <div className="absolute top-16 right-2 text-white -rotate-12 animate-pulse">
          <Sparkles size={20} />
        </div>
        <div className="absolute bottom-8 right-4 text-white -rotate-12">
          <Star size={40} fill="currentColor" />
        </div>
      </div>
    ),
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4">
        <div className="font-cherry text-2xl text-white text-center tracking-wider drop-shadow-[0_2px_0_rgba(0,0,0,0.2)] mt-1">
          SUPER CUTE
        </div>
        <div className="absolute top-[5%] left-2 text-4xl">✨</div>
        <div className="absolute top-[5%] right-2 text-4xl">⭐</div>
  ...
  },
  {
    ...
    renderBackground: () => (
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_rgba(255,255,255,0.1),_transparent)] opacity-50" />
        <div className="absolute top-0 w-full h-6 bg-black/80 flex justify-around items-center">
          {Array.from({
            length: 6,
          }).map((_, i) => (
        ...
        <div className="absolute bottom-0 w-full h-6 bg-black/80 flex justify-around items-center">
          {Array.from({
            length: 6,
          }).map((_, i) => (
            <div key={i} className="w-3 h-3 bg-white/80 rounded-sm" />
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4">
        <div className="flex justify-center mt-2">
          <Clapperboard className="text-yellow-400 drop-shadow-md" size={32} />
        </div>
        <div className="absolute top-[5%] left-2 text-4xl">🍿</div>
        <div className="absolute top-[5%] right-2 text-4xl">🎟️</div>
        <div className="absolute bottom-[10%] left-2 text-3xl">🎬</div>
        <div className="absolute bottom-[10%] right-2 text-3xl">✨</div>
        <div className="absolute top-[30%] left-1 text-2xl">🎥</div>
        <div className="absolute top-[30%] right-1 text-2xl">🎞️</div>
        <div className="absolute bottom-[35%] left-2 text-xl">🌟</div>
        <div className="absolute bottom-[35%] right-2 text-xl">⭐</div>
        <div className="text-center font-mono text-yellow-400 text-xs tracking-widest bg-black/60 py-0.5 rounded mb-1">
          CINEMA
        </div>
      </div>
    ),
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none border-3 border-black/30 m-2 rounded-lg flex flex-col justify-between p-4">
        <div className="text-center font-mono text-black/70 text-[9px] font-bold tracking-widest bg-white/40 rounded py-0.5">
          🤠 COWBOY LAND ⭐
        </div>
        <div className="absolute top-[5%] left-2 text-4xl">🐴</div>
        <div className="absolute top-[5%] right-2 text-4xl">🤠</div>
  ...
  // ============================================================
  // INSTAGRAM COUNTERPARTS FOR BIASA THEMES
  // ============================================================
  {
    id: 'strawberry-jam-ig',
    name: 'Strawberry Jam',
    section: 'instagram',
    frameCount: 2,
    frameShape: 'blob',
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none border-8 border-white/30 rounded-xl m-2 flex flex-col justify-between">
        ...
        <div className="absolute top-[5%] -right-3 text-3xl rotate-12">🌸</div>
        <div className="absolute bottom-[10%] -left-3 text-3xl -rotate-12">
          🌸
        </div>
        <div className="absolute bottom-4 w-full text-center font-pacifico text-white text-sm drop-shadow-md bg-black/20 py-1 backdrop-blur-[1px]">
          Berry Sweet
        </div>
      </div>
    ),
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4">
        ...
        <div className="absolute top-[5%] -left-2 text-4xl rotate-[-15deg] animate-bounce">
          🎀
        </div>
        <div className="absolute top-[5%] -right-2 text-4xl rotate-[15deg] animate-bounce">
          🎀
        </div>
        <div className="absolute bottom-[10%] left-3 text-3xl">💕</div>
        <div className="absolute bottom-[10%] right-3 text-3xl">💗</div>
        <div className="bg-black/10 text-white text-center font-pacifico text-sm py-1 border-y border-white/30 backdrop-blur-sm mx-4 mb-1">
          🎀 coquette 🎀
        </div>
      </div>
    ),
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4">
        <div className="font-pacifico text-white text-2xl text-center mt-2 drop-shadow-md">
          Beach Vibe
        </div>
        <div className="absolute top-[5%] left-2 text-4xl">🍦</div>
        <div className="absolute top-[5%] right-2 text-4xl">🍹</div>
        <div className="absolute bottom-[10%] left-3 text-3xl">🏄‍♂️</div>
        <div className="absolute bottom-[10%] right-3 text-3xl">🏖️</div>
        <div className="flex justify-between items-end mb-2 px-2">
          <Palmtree className="text-green-600 drop-shadow-sm" size={32} />
          <Waves className="text-blue-500 drop-shadow-sm" size={32} />
        </div>
      </div>
    ),
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4">
        <div className="bg-white/90 text-gray-800 rounded-full px-3 py-1 font-cherry text-center border-2 border-white shadow-md rotate-[-3deg] text-sm mx-auto mt-1">
          CANDY POP!
        </div>
        <div className="absolute top-[5%] left-2 text-4xl">🍭</div>
        <div className="absolute top-[5%] right-2 text-4xl">🍒</div>
  ...
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none p-4 flex flex-col justify-between border-4 border-white/60 m-2 rounded-2xl shadow-inner">
        <div className="text-2xl text-center bg-white/50 rounded-full py-1 mt-1">
          🐾 ฅ(=•́⎑•̀=)
        </div>
        <div className="absolute top-[5%] left-2 text-4xl">🐱</div>
        <div className="absolute top-[5%] right-2 text-4xl">🐟</div>
  ...
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4 border-4 border-white/40 m-1">
        <div className="flex justify-between text-white drop-shadow-md mt-1">
        ...
        <div className="absolute bottom-[10%] left-3 text-3xl">🦋</div>
        <div className="absolute bottom-[10%] right-3 text-3xl">💋</div>
        <div className="font-cherry text-white text-center text-sm tracking-widest bg-black/40 px-2 py-1 rounded-md border border-white/50 mx-2 mb-1">
          ⚡ COLLAGE ⚡
        </div>
      </div>
    ),
  ...
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4">
        ...
        <div className="absolute top-[5%] -left-2 text-4xl rotate-[-15deg]">
          👻
        </div>
        <div className="absolute top-[35%] -right-2 text-4xl rotate-[15deg]">
          🎃
        </div>
        <div className="absolute bottom-[10%] -left-2 text-3xl">🦇</div>
      </div>
  ...
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4">
        <div className="text-center font-pacifico text-teal-700 text-xl drop-shadow-sm mt-2">
          Fresh & Clean
        </div>
        <div className="absolute top-[5%] left-2 text-4xl">🍃</div>
        <div className="absolute top-[5%] right-2 text-4xl">✨</div>
  ...
  },
  {
    ...
    renderBackground: () => (
      <div className="absolute inset-0 bg-gradient-to-b from-black/60 to-transparent opacity-80">
        ...
        <div className="absolute bottom-16 right-4 text-white/40">
          <Moon size={40} />
        </div>
      </div>
    ),
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4 border-4 border-black/80 m-2 rounded-xl">
        <div className="font-cherry text-center text-black text-lg tracking-widest bg-white/80 py-1 rounded-md border-2 border-black mt-1">
          TRICK OR TREAT
        </div>
        <div className="absolute top-[5%] left-2 text-4xl">🎃</div>
        <div className="absolute top-[5%] right-2 text-4xl">🦇</div>
  ...
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4">
        <div className="bg-white/90 text-yellow-600 font-bold text-center py-1 px-4 rounded-full border-2 border-yellow-400 shadow-sm mx-auto mt-2 rotate-[-2deg] text-sm">
          🍋 SQUEEZE THE DAY 🍋
        </div>
        <div className="absolute top-[5%] left-2 text-4xl">☀️</div>
        <div className="absolute top-[5%] right-2 text-4xl">🍹</div>
  ...
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4 border-4 border-white/50 m-2 rounded-3xl">
        <div className="font-pacifico text-white text-2xl text-center drop-shadow-md mt-1">
          Royal Vibes
        </div>
        <div className="absolute top-[5%] left-2 text-4xl">👑</div>
        <div className="absolute top-[5%] right-2 text-4xl">✨</div>
  ...
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4">
        <div className="font-pacifico text-cyan-700 text-xl text-center drop-shadow-sm mt-2">
          Splash!
        </div>
        <div className="absolute top-[5%] left-2 text-4xl">🫧</div>
        <div className="absolute top-[5%] right-2 text-4xl">🐬</div>
  ...
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4">
        <div className="font-cherry text-xl text-indigo-100 text-center tracking-widest drop-shadow-[0_2px_0_rgba(0,0,0,0.3)] mt-1">
          COSMIC
        </div>
        <div className="absolute top-[5%] left-2 text-4xl">🪐</div>
        <div className="absolute top-[5%] right-2 text-4xl">🌌</div>
  ...
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4 border-4 border-white/50 m-2 rounded-3xl">
        <div className="font-pacifico text-orange-500 text-xl text-center drop-shadow-sm mt-1">
          So Peachy
        </div>
        <div className="absolute top-[5%] left-2 text-4xl">🍑</div>
        <div className="absolute top-[5%] right-2 text-4xl">🌼</div>
  ...
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4">
        <div className="bg-white/80 text-green-700 font-cherry text-center py-1 px-3 rounded-full border-2 border-green-300 shadow-sm mx-auto mt-2 rotate-[-2deg] text-sm">
          🌳 WOODLAND 🍂
        </div>
        <div className="absolute top-[5%] left-2 text-4xl">🦊</div>
        <div className="absolute top-[5%] right-2 text-4xl">🦉</div>
  ...
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4">
        <div className="font-cherry text-pink-500 text-xl text-center drop-shadow-[0_2px_0_#fff] mt-1">
          PARTY!
        </div>
        <div className="absolute top-[5%] left-2 text-4xl">🎂</div>
        <div className="absolute top-[5%] right-2 text-4xl">🎉</div>
  ...
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4 border-4 border-white/50 m-2 rounded-3xl">
        <div className="font-pacifico text-pink-400 text-xl text-center drop-shadow-sm mt-1">
          Sweet Dream
        </div>
        <div className="absolute top-[5%] left-2 text-4xl">🍭</div>
        <div className="absolute top-[5%] right-2 text-4xl">☁️</div>
  ...
  },
  {
    ...
    renderBackground: () => (
      <div className="absolute inset-0 overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              'linear-gradient(to right, #FF00FF 1px, transparent 1px), linear-gradient(to bottom, #00FFFF 1px, transparent 1px)',
            backgroundSize: '20px 20px',
          }}
        />
      </div>
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4 border-2 border-cyan-400 m-2 rounded-xl shadow-[0_0_15px_#00FFFF_inset]">
        <div className="font-mono text-cyan-400 text-center font-bold tracking-[0.3em] bg-black/80 py-1 px-2 rounded border border-cyan-400 mx-auto mt-1 text-xs">
          NEON_CITY
        </div>
        <div className="absolute top-[5%] left-2 text-4xl">🌃</div>
        <div className="absolute top-[5%] right-2 text-4xl">⚡</div>
  ...
  },
  {
    ...
    renderBackground: () => (
      <div
        ...
        style={{
          backgroundImage:
            'repeating-linear-gradient(45deg, #FFD700 0px, #FFD700 10px, transparent 10px, transparent 22px)',
        }}
      >
  ...
  },
  {
    ...
    renderBackground: () => (
      <div
        ...
        style={{
          backgroundImage:
            'radial-gradient(circle, #FFD700 4px, transparent 4px)',
          backgroundSize: '28px 28px',
        }}
      >
        <div className="absolute top-6 left-4 text-white/60">
          <Music size={40} />
        </div>
      </div>
    ),
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4 border-4 border-white/50 m-2 rounded-xl">
        <div className="font-cherry text-white text-xl text-center drop-shadow-[0_2px_0_rgba(0,0,0,0.3)] mt-1">
          FESTIVAL
        </div>
        <div className="absolute top-[5%] left-2 text-4xl">🎸</div>
        <div className="absolute top-[5%] right-2 text-4xl">🎤</div>
  ...
  // ============================================================
  // BIASA COUNTERPARTS FOR INSTAGRAM-ONLY THEMES
  // ============================================================
  {
    id: 'cherry-gingham-strip',
    name: 'Cherry Gingham',
    section: 'biasa',
    frameCount: 3,
    frameShape: 'rect',
  ...
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none p-4 flex flex-col justify-between">
        ...
        <div className="absolute top-[12%] left-2 text-4xl">🌅</div>
        <div className="absolute top-[12%] right-2 text-4xl">☁️</div>
        <div className="absolute bottom-[20%] left-2 text-3xl">⭐</div>
        <div className="absolute bottom-[20%] right-2 text-3xl">🕊️</div>
        <div className="absolute top-[35%] left-1 text-2xl">🌤️</div>
        <div className="absolute top-[35%] right-1 text-2xl">🌇</div>
      </div>
    ),
  },
  {
    id: 'acid-smiley-strip',
    name: 'Retro Grid',
    section: 'biasa',
    frameCount: 3,
    frameShape: 'rect',
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none p-4 flex flex-col justify-between m-1">
        ...
        <div className="absolute top-[12%] left-2 text-4xl">✌️</div>
        <div className="absolute top-[12%] right-2 text-4xl">📸</div>
        <div className="absolute bottom-[20%] left-2 text-3xl">🌟</div>
        <div className="absolute bottom-[20%] right-2 text-3xl">🎈</div>
        <div className="absolute top-[35%] left-1 text-2xl">😎</div>
  ...
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-5 border-2 border-white/60 m-2 rounded-xl">
        ...
        <div className="absolute top-[12%] left-3 text-5xl text-gray-500/40 rotate-[-8deg]">
          ◈
        </div>
        <div className="absolute top-[12%] right-3 text-5xl text-gray-500/40 rotate-[8deg]">
          ◈
        </div>
        <div className="absolute bottom-[20%] left-3 text-3xl text-gray-600">
          ✦
        </div>
        <div className="absolute bottom-[20%] right-3 text-3xl text-gray-600">
          ✦
        </div>
        <div className="absolute top-[35%] left-2 text-2xl text-gray-500">
          ◆
        </div>
        <div className="absolute top-[35%] right-2 text-2xl text-gray-500">
          ◆
        </div>
      </div>
    ),
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-6 border-[3px] border-white/30 m-3 rounded-[3rem]">
        ...
        <div className="absolute top-[12%] left-4 text-7xl text-white/30 rotate-[-12deg]">
          ✦
        </div>
        <div className="absolute top-[12%] right-4 text-6xl text-white/30 rotate-[12deg]">
          ✦
        </div>
        <div className="absolute bottom-[20%] left-4 text-4xl text-white/50">
          ◈
        </div>
        <div className="absolute bottom-[20%] right-4 text-4xl text-white/50">
          ◈
        </div>
        <div className="absolute top-[35%] left-3 text-3xl text-white/40">
          ◆
        </div>
        <div className="absolute top-[35%] right-3 text-3xl text-white/40">
          ◆
        </div>
      </div>
    ),
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4 border-[6px] border-white/60 m-1.5 rounded-xl shadow-sm">
        ...
        <div className="absolute top-[12%] left-2 text-4xl text-cyan-400">
          💾
        </div>
        <div className="absolute top-[12%] right-2 text-4xl text-cyan-400">
          🕹️
        </div>
        <div className="absolute bottom-[20%] left-2 text-3xl text-cyan-400">
          ⚡
        </div>
        <div className="absolute bottom-[20%] right-2 text-3xl text-cyan-400">
          👾
        </div>
        <div className="absolute top-[35%] left-1 text-2xl text-cyan-400">
          💻
        </div>
        <div className="absolute top-[35%] right-1 text-2xl text-cyan-400">
          💿
        </div>
        <div className="flex justify-between items-center text-cyan-600/80 px-2 mb-1 bg-white/80 py-0.5 rounded-md border border-white">
          <span className="font-mono text-[9px] uppercase tracking-widest font-black">
  ...
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-3 border-[8px] border-white/50 m-1 rounded-2xl shadow-inner">
        ...
        <div className="absolute top-[10%] left-2 text-4xl">🌸</div>
        <div className="absolute top-[10%] right-2 text-4xl">🌷</div>
        <div className="absolute bottom-[15%] left-2 text-3xl">🍭</div>
  ...
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-6 border-[6px] border-white/80 m-3 rounded-full shadow-lg">
        ...
        <div className="absolute top-[15%] left-4 text-5xl">🍬</div>
        <div className="absolute top-[15%] right-4 text-5xl">🎈</div>
        <div className="absolute bottom-[20%] left-4 text-4xl">💖</div>
        <div className="absolute bottom-[20%] right-4 text-4xl">🫧</div>
        <div className="absolute top-[35%] left-2 text-3xl">🍭</div>
  ...
  },
  {
    ...
    renderForeground: () => (
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4 border-4 border-white/60 m-2 rounded-2xl">
        ...
        <div className="absolute bottom-[20%] right-2 text-3xl">🌺</div>
        <div className="absolute top-[35%] left-1 text-2xl">🍹</div>
        <div className="absolute top-[35%] right-1 text-2xl">☀️</div>
      </div>
    ),
  },
  {
    id: 'frosty-winter-strip',
    name: 'Frosty Winter',
    section: 'biasa',
    frameCount: 3,
    frameShape: 'arch',
